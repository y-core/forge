...
export const GOLDEN: readonly GoldenQuery[] = [
  ...
  { query: "how many of something may a document state", expect: "canon:AGENT_GUIDE.md#9b", dimension: "prohibition" },
  ...
  { query: "where does API key rotation belong", expect: "project:docs/NAMESPACES.md#5a", within: 4, dimension: "placement" },
  ...
  { query: "sign and harden the session cookie", expect: "project:src/session/README.md#~security", within: 2, dimension: "reference" },
  {
    ...
    expect: "project:src/router/README.md#~listing-the-paths-a-route-map-declares",
    within: 2,
    dimension: "reference",
  },
  {
    query: "share a config store without importing it",
    expect: "project:src/config/README.md#~sharing-a-store-without-importing-it",
    within: 2,
    dimension: "reference",
  },
  {
    query: "choose which second factor a deployment demands",
    expect: "project:src/auth/README.md#~choosing-which-factors-a-deployment-offers",
    within: 2,
    dimension: "reference",
  },
  { query: "mintCsrf csrfMinter", expect: "project:src/form/README.md#~minting-a-token-for-another-path", within: 2, dimension: "reference" },
  {
    query: "cacheControl header builder",
    expect: "project:src/http/README.md#~setting-a-header-other-than-content-type",
    within: 2,
    dimension: "reference",
  },
  {
    query: "svg sanitisation sprite",
    expect: "project:src/tooling/assets/README.md#~building-sprite-sheets~choosing-which-svgs-to-trust",
    within: 2,
    dimension: "reference",
  },
];
