...
**The boundaries** — `BOUNDARIES.md` is binding on every edit: never import browser-only code from a Worker-reachable file, never put identity
...
- `libs/ERROR_HANDLING.md` §1 owns the primitive; §5 owns the taxonomy
