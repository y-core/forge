...
> [`NAMESPACE_DESIGN.md`](../warden/canon/libs/NAMESPACE_DESIGN.md) §1c for what `validate-exports` proves.
...
one ([`TESTING.md`](../warden/canon/libs/TESTING.md) §6c).
...
See [`TESTING.md`](../warden/canon/libs/TESTING.md) §3b for the exact-match rule and why a substring assertion on markup is a defect.
...
`*.browser.tsx`. Its finding cites [`TESTING.md`](../warden/canon/libs/TESTING.md) §3b — the shape it is
...
See [`TESTING.md`](../warden/canon/libs/TESTING.md) §4 for the fakes-over-mocks posture, the
...
See [`TESTING.md`](../warden/canon/libs/TESTING.md) §5a for the both-directions requirement and the guard matrix. forge builds the app under
...
See [`TESTING.md`](../warden/canon/libs/TESTING.md) §5b for the rule that a negative case asserts the exact status **and** a meaningful body.

### 5c. No Mocking of Security Primitives

See [`TESTING.md`](../warden/canon/libs/TESTING.md) §5c for the ban on mocking a security primitive, and why an untestable primitive is a
...
See [`TESTING.md`](../warden/canon/libs/TESTING.md) §6 for the one-command-three-modes gate, the flag
