...
> [`UI_SSR_COMPONENTS.md`](./UI_SSR_COMPONENTS.md) §3d and §3h for class precedence and the recipe
...
[`UI_SSR_COMPONENTS.md`](./UI_SSR_COMPONENTS.md) §3d gives about `class-groups.ts`.
...
principle as class precedence ([`UI_SSR_COMPONENTS.md`](./UI_SSR_COMPONENTS.md) §3d) on a different
...
mechanism: `state-busy` ([`UI_SSR_COMPONENTS.md`](./UI_SSR_COMPONENTS.md) §3h) is what paints it, and
