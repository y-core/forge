...
See [`BOUNDARIES.md`](../governance/BOUNDARIES.md) §5 for the fail-closed posture, the
...
See [`ERROR_HANDLING.md`](../governance/ERROR_HANDLING.md) §5a for the tier itself and the
