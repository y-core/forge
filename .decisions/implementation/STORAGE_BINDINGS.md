...
>
> Defers to: [`BOUNDARIES.md`](../governance/BOUNDARIES.md) §5a and §5b for the fail-closed posture
...
non-security-critical features only (§5b, [`BOUNDARIES.md`](../governance/BOUNDARIES.md) §5b).
...
([`BOUNDARIES.md`](../governance/BOUNDARIES.md) §5a owns the posture). Use `validateBindings` (§4b) to guarantee those bindings exist before the worker
