...
import { lintKeyOf, RULE_CORPUS_PATH, RULE_ENFORCER, type RuleId } from "../../lint/design-rules";
import { MODERN_CSS_RULES } from "../../lint/modern-css-rules";
import plugin from "../../lint/plugin";
...
// Each states a rule a `.decisions/` doc owns rather than a corpus file, so neither register names
