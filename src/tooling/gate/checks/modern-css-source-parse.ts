...
// A `color-mix()` with an alpha composites against whatever sits behind it, and ring, border and
// outline tokens carry a WCAG 1.4.11 3:1 floor of their own (`reference/09-interaction.md`).
