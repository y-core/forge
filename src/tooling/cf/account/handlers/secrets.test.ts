...
describe("secret values never reach a result row", () => {
  ...
  // The realistic leak is an API error message echoing the payload, not a handler printing
  // `entry.value` directly — so the stub's error message carries the sentinel.
