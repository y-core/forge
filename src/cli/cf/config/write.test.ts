...
import { countComments } from "./jsonc";
...
// A config shaped like the real ones: load-bearing commentary, a `https://` inside a
// comment and another inside a string value, a trailing comment on a member, and a
// bare kv_namespaces entry with no id yet.
const INPUT = `{
  "name": "my-site",
