...
/**
 * The SGR table for one colour level.
 *
 * A factory rather than module constants, because the level is a property of the stream being
 * written to and forge resolves two of them — a redirected stdout and an attached stderr do not
 * get the same table. Degradation is driven by the level integer alone: at 2 an RGB request
 * becomes the nearest 256-palette entry, at 1 the nearest of the sixteen, at 0 the empty string.
 * @public
 */
