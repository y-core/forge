...
import { checkClassGroups, type ClassGroupsCheckConfig, writeClassGroups } from "./class-groups";
import { hasTailwind } from "./design-system";

const ROOT = resolve(import.meta.dir, "../../../../..");
const CONFIG: ClassGroupsCheckConfig = { root: ROOT, stylesheet: "src/ui/assets/css/tailwind.css", table: "src/ui/core/utils/class-groups.ts" };
