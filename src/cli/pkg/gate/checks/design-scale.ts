...
if (import.meta.main) {
  ...
  await writeDesignScale({ root, stylesheet: "src/ui/assets/css/tailwind.css", table: "src/cli/pkg/lint/data/design-scale.ts" });
  console.log("wrote src/cli/pkg/lint/data/design-scale.ts");
}
