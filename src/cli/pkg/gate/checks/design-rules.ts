...
export const RULE_ENFORCER: Readonly<Record<RuleId, RuleEnforcer>> = {
  ...
  "forge-ui-color-theme-no-raw-utility": "gate",
  "forge-ui-no-inline-style": "gate",
  "forge-ui-spacing-scale-only": "lint",
  "forge-ui-no-nested-card": "gate",
  "forge-ui-interaction-focus-visible": "gate",
  "forge-ui-catalog-wrong-raw-input": "gate",
  "forge-ui-contrast-floor": "contrast",
  "forge-ui-a11y-label-association": "gate",
  "forge-ui-a11y-live-politeness": "gate",
  "forge-ui-a11y-no-aria-readonly-on-button": "gate",
  "forge-ui-a11y-one-live-region": "gate",
  "forge-ui-a11y-aria-beside-data": "gate",
  "forge-ui-a11y-heading-size-by-class": "lint",
  "forge-ui-reduced-motion": "lint",
  "forge-ui-focus-ring": "gate",
};
