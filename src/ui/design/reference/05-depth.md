...
sits _closer to the user_ than what it covers. Five levels express every distance a product UI has,
...
region that is merely _important_ is not closer, and takes weight or spacing instead. Override when
