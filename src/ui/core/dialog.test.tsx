...
describe("Dialog", () => {
  it("renders a <dialog> with the given id and data-slot=dialog", async () => {
    expect(await render(<Dialog id='confirm'>Body</Dialog>)).toBe(
      '<dialog id="confirm" data-slot="dialog" data-closed="" class="rounded-xl border border-border bg-popover p-0 text-popover-foreground shadow-lg">Body</dialog>',
    );
  });
  ...
  it("merges a custom class", async () => {
    expect(
      ...
      '<dialog id="confirm" data-slot="dialog" data-closed="" class="rounded-xl border border-border bg-popover p-0 text-popover-foreground shadow-lg w-96">Body</dialog>',
    );
  });
});
