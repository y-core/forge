...
const sizeClasses: Record<Size, string> = { sm: "size-8 text-xs", md: "size-10 text-sm", lg: "size-14 text-base" };
...
const AvatarImage: FC<AvatarImageProps> = ({ class: cls, alt, "data-slot": inherited, ...props }) => (
  <img data-slot={slotToken("avatar-image", inherited)} class={cn("aspect-square size-full object-cover", cls)} alt={alt} {...props} />
);
