...
export const Label: FC<LabelProps> = ({ required, class: cls, for: htmlFor, children, "data-slot": inherited, ...props }) => (
  <label data-slot={slotToken("label", inherited)} for={htmlFor} class={cn(FIELD_LABEL_CLASSES, cls)} {...props}>
    {children}
    {required ? (
      <span data-slot='label-required' aria-hidden='true' class='ms-0.5 text-destructive-text'>
        *
      </span>
    ) : null}
  </label>
