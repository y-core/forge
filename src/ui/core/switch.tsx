...
const SWITCH_TRACK = cn(
  "relative h-5 w-9 shrink-0 rounded-full bg-track peer-checked:bg-primary peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-disabled:opacity-50 motion-safe:transition-colors",
);
const SWITCH_THUMB = cn(
  "absolute top-0.5 left-0.5 size-4 rounded-full bg-background motion-safe:transition-transform " +
