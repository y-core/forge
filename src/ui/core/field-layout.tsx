...
const FieldSet: FC<PropsWithChildren<FieldSetProps>> = ({ class: cls, children, "data-slot": inherited, ...props }) => (
  <fieldset data-slot={slotToken("field-set", inherited)} class={cn("flex flex-col gap-6", asClass(cls))} {...props}>
    {children}
  </fieldset>
);

const FieldLegend: FC<PropsWithChildren<FieldLegendProps>> = ({ class: cls, variant = "legend", children, "data-slot": inherited, ...props }) => (
  <legend
...
const FieldGroup: FC<PropsWithChildren<FieldGroupProps>> = ({ class: cls, children, "data-slot": inherited, ...props }) => (
  <div data-slot={slotToken("field-group", inherited)} class={cn("@container/field-group flex w-full flex-col gap-6", asClass(cls))} {...props}>
    {children}
  </div>
);

const FieldContent: FC<PropsWithChildren<FieldContentProps>> = ({ class: cls, children, "data-slot": inherited, ...props }) => (
  <div data-slot={slotToken("field-content", inherited)} class={cn("flex flex-1 flex-col gap-1.5 leading-snug", asClass(cls))} {...props}>
    {children}
  </div>
);

const FieldTitle: FC<PropsWithChildren<FieldTitleProps>> = ({ class: cls, children, "data-slot": inherited, ...props }) => (
  <div data-slot={slotToken("field-title", inherited)} class={cn(FIELD_LABEL_CLASSES, asClass(cls))} {...props}>
    {children}
  </div>
);
