...
describe("renderPreview", () => {
  ...
  it("body contains the preview wrapper id", async () => {
    ...
    expect(body).toBe(
      '<div id="show-preview-button" class="flex items-center justify-center rounded-xl border border-border bg-muted p-8"><button type="button" data-slot="button" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input text-foreground hover:bg-accent h-8 px-3 text-sm">Preview</button></div>',
    );
  });
});
...
describe("renderPaginate", () => {
  ...
  it("body contains the paginate id", async () => {
    ...
    const body = await res.text();
    expect(body).toBe(
      '<div id="show-paginate-table"><table class="w-full border-collapse text-sm"><thead><tr class="border-b border-border text-start text-xs font-semibold uppercase tracking-wide text-muted-foreground"><th class="py-2 ps-4 pe-4">#</th><th class="py-2 pe-4">Component</th><th class="py-2 pe-4">Category</th></tr></thead><tbody><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">1</td><td class="py-2 pe-4 font-medium text-foreground">Alert</td><td class="py-2 pe-4 text-muted-foreground">Feedback</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">2</td><td class="py-2 pe-4 font-medium text-foreground">Avatar</td><td class="py-2 pe-4 text-muted-foreground">Display</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">3</td><td class="py-2 pe-4 font-medium text-foreground">Badge</td><td class="py-2 pe-4 text-muted-foreground">Display</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">4</td><td class="py-2 pe-4 font-medium text-foreground">Button</td><td class="py-2 pe-4 text-muted-foreground">Action</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">5</td><td class="py-2 pe-4 font-medium text-foreground">Card</td><td class="py-2 pe-4 text-muted-foreground">Layout</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">6</td><td class="py-2 pe-4 font-medium text-foreground">Field</td><td class="py-2 pe-4 text-muted-foreground">Form</td></tr></tbody></table><div class="flex items-center justify-between border-t border-border px-4 py-3"><span class="text-xs text-muted-foreground">Page 1 of 4</span><div class="flex gap-2"><button type="button" data-slot="button" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input text-foreground hover:bg-accent h-8 px-3 text-sm" hx-get="/showcase/paginate?page=2" hx-target="#show-paginate-table" hx-swap="outerHTML">Next</button></div></div></div>',
    );
  });
  ...
  it("Previous button is present on page 2", async () => {
    ...
    const body = await res.text();
    expect(body).toBe(
      '<div id="show-paginate-table"><table class="w-full border-collapse text-sm"><thead><tr class="border-b border-border text-start text-xs font-semibold uppercase tracking-wide text-muted-foreground"><th class="py-2 ps-4 pe-4">#</th><th class="py-2 pe-4">Component</th><th class="py-2 pe-4">Category</th></tr></thead><tbody><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">7</td><td class="py-2 pe-4 font-medium text-foreground">Form</td><td class="py-2 pe-4 text-muted-foreground">Form</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">8</td><td class="py-2 pe-4 font-medium text-foreground">Icon</td><td class="py-2 pe-4 text-muted-foreground">Display</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">9</td><td class="py-2 pe-4 font-medium text-foreground">Input</td><td class="py-2 pe-4 text-muted-foreground">Form</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">10</td><td class="py-2 pe-4 font-medium text-foreground">Label</td><td class="py-2 pe-4 text-muted-foreground">Form</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">11</td><td class="py-2 pe-4 font-medium text-foreground">Popover</td><td class="py-2 pe-4 text-muted-foreground">Overlay</td></tr><tr class="border-b border-border hover:bg-accent"><td class="py-2 ps-4 pe-4 font-mono text-xs text-muted-foreground">12</td><td class="py-2 pe-4 font-medium text-foreground">Progress</td><td class="py-2 pe-4 text-muted-foreground">Feedback</td></tr></tbody></table><div class="flex items-center justify-between border-t border-border px-4 py-3"><span class="text-xs text-muted-foreground">Page 2 of 4</span><div class="flex gap-2"><button type="button" data-slot="button" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input text-foreground hover:bg-accent h-8 px-3 text-sm" hx-get="/showcase/paginate?page=1" hx-target="#show-paginate-table" hx-swap="outerHTML">Previous</button><button type="button" data-slot="button" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input text-foreground hover:bg-accent h-8 px-3 text-sm" hx-get="/showcase/paginate?page=3" hx-target="#show-paginate-table" hx-swap="outerHTML">Next</button></div></div></div>',
    );
  });
});
...
describe("renderDependent", () => {
  ...
  it("renders fruit options for fruit category", async () => {
    ...
    const body = await res.text();
    expect(body).toBe(
      '<fieldset data-slot="field" data-orientation="vertical" class="group/field flex w-full data-[invalid]:text-destructive flex-col [&amp;&gt;*]:w-full gap-1.5" id="show-dependent-select"><label data-slot="field-label" class="flex w-fit items-center gap-2 text-sm font-medium leading-snug text-foreground group-data-[disabled]/field:opacity-50" for="dependent-item">Item</label><div data-slot="select-wrapper" class="group/select relative w-full has-[select:disabled]:opacity-50"><select data-slot="select" class="w-full appearance-none rounded-lg border border-input bg-background ps-3 py-2 pe-10 text-sm text-foreground focus-visible:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/20 disabled:cursor-not-allowed disabled:pointer-events-none" id="dependent-item" name="item"><option data-slot="select-option" value="apple">Apple</option><option data-slot="select-option" value="banana">Banana</option><option data-slot="select-option" value="cherry">Cherry</option><option data-slot="select-option" value="mango">Mango</option><option data-slot="select-option" value="papaya">Papaya</option></select><span aria-hidden="true" data-slot="select-icon" class="pointer-events-none absolute inset-y-0 end-3 flex items-center text-muted-foreground"></span></div></fieldset>',
    );
  });
  ...
  it("renders vegetable options for vegetable category", async () => {
    ...
    const body = await res.text();
    expect(body).toBe(
      '<fieldset data-slot="field" data-orientation="vertical" class="group/field flex w-full data-[invalid]:text-destructive flex-col [&amp;&gt;*]:w-full gap-1.5" id="show-dependent-select"><label data-slot="field-label" class="flex w-fit items-center gap-2 text-sm font-medium leading-snug text-foreground group-data-[disabled]/field:opacity-50" for="dependent-item">Item</label><div data-slot="select-wrapper" class="group/select relative w-full has-[select:disabled]:opacity-50"><select data-slot="select" class="w-full appearance-none rounded-lg border border-input bg-background ps-3 py-2 pe-10 text-sm text-foreground focus-visible:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/20 disabled:cursor-not-allowed disabled:pointer-events-none" id="dependent-item" name="item"><option data-slot="select-option" value="broccoli">Broccoli</option><option data-slot="select-option" value="carrot">Carrot</option><option data-slot="select-option" value="celery">Celery</option><option data-slot="select-option" value="kale">Kale</option><option data-slot="select-option" value="spinach">Spinach</option></select><span aria-hidden="true" data-slot="select-icon" class="pointer-events-none absolute inset-y-0 end-3 flex items-center text-muted-foreground"></span></div></fieldset>',
    );
  });
});
