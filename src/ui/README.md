...
[`THEME_GENERATION.md`](../../.decisions/implementation/THEME_GENERATION.md) §1d.
...
([`UI_SSR_COMPONENTS.md`](../../.decisions/implementation/UI_SSR_COMPONENTS.md) §5c). Each of those four intents also
carries a `--X-text` sibling — the tone read as text on a page surface — because the fill is held across modes and the
text step is not ([`THEME_GENERATION.md`](../../.decisions/implementation/THEME_GENERATION.md) §4).
...
([`UI_SSR_COMPONENTS.md`](../../.decisions/implementation/UI_SSR_COMPONENTS.md) §1m). The values
...
| `toneVariants`                                                                                                  | cva function                           | The `tone` × `appearance` paint every toned component composes over — six `--tone*` custom properties per tone, one recipe per appearance ([`UI_SSR_COMPONENTS.md`](../../.decisions/implementation/UI_SSR_COMPONENTS.md) §3h).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
([`STATE_ATTRIBUTES.md`](../../.decisions/implementation/STATE_ATTRIBUTES.md) §1a and §1b). **Open state is deliberately
...
JavaScript ([`THEME_GENERATION.md`](../../.decisions/implementation/THEME_GENERATION.md) §2d).
