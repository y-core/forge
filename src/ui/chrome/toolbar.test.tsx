...
describe("Toolbar — action dispatch", () => {
  ...
  it("emits a native --command targeting commandTarget when dispatch is command", async () => {
    ...
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" command="--select" commandfor="chrome-root" data-tool="select"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></nav>',
    );
  });
});
...
describe("Toolbar — glyph typing", () => {
  ...
  it("accepts a sheet narrowed to the definition's glyphs, uncast", async () => {
    ...
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" data-on-click="select"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></nav>',
    );
  });
