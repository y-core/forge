...
describe("Toolbar — popover title", () => {
  it("renders toolbar-flyout-title with the popover label", async () => {
    ...
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><div data-slot="toolbar-popover" class="relative flex flex-col items-center w-full"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-0" aria-controls="toolbar-flyout-left-0" aria-expanded="false" title="Groups" aria-label="Groups"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-left-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 p-2 pb-2.5 rounded-xl border border-border bg-popover text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-0.5 pb-1.5 px-0.5 flex items-center justify-between gap-2"><span>Groups</span></div><div data-slot="toolbar-flyout-body" class="flex flex-col items-stretch gap-3.5 pt-1 pb-0.5 px-0.5 max-h-[60vh] overflow-y-auto"><div></div></div></div></div></div></nav>',
    );
  });
  ...
  it("renders the title as a flex row (label + no action button) without titleAction", async () => {
    ...
    const out = await render(<Toolbar config={config} icon={icon} />);
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><div data-slot="toolbar-popover" class="relative flex flex-col items-center w-full"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-0" aria-controls="toolbar-flyout-left-0" aria-expanded="false" title="Layers" aria-label="Layers"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-left-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 p-2 pb-2.5 rounded-xl border border-border bg-popover text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-0.5 pb-1.5 px-0.5 flex items-center justify-between gap-2"><span>Layers</span></div><div data-slot="toolbar-flyout-body" class="flex flex-col items-stretch gap-3.5 pt-1 pb-0.5 px-0.5 max-h-[60vh] overflow-y-auto"><div></div></div></div></div></div></nav>',
    );
  });
...
describe("Toolbar — native popover flyout", () => {
  ...
  it("renders the flyout as a native popover carrying the linking id and placement", async () => {
    ...
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><div data-slot="toolbar-popover" class="relative flex flex-col items-center w-full"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-right-0" aria-controls="toolbar-flyout-right-0" aria-expanded="false" title="Layers" aria-label="Layers"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-right-0" data-slot="toolbar-flyout" popover="auto" data-placement="right" class="min-w-52 p-2 pb-2.5 rounded-xl border border-border bg-popover text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-0.5 pb-1.5 px-0.5 flex items-center justify-between gap-2"><span>Layers</span></div><div data-slot="toolbar-flyout-body" class="flex flex-col items-stretch gap-3.5 pt-1 pb-0.5 px-0.5 max-h-[60vh] overflow-y-auto"><div></div></div></div></div></div></nav>',
    );
  });
  ...
  it("mints a distinct id for each popover so triggers and flyouts stay paired", async () => {
    ...
    const out = await render(<Toolbar config={config} icon={icon} />);
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><div data-slot="toolbar-popover" class="relative flex flex-col items-center w-full"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-0" aria-controls="toolbar-flyout-left-0" aria-expanded="false" title="A" aria-label="A"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-a"></use></svg></button><div id="toolbar-flyout-left-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 p-2 pb-2.5 rounded-xl border border-border bg-popover text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-0.5 pb-1.5 px-0.5 flex items-center justify-between gap-2"><span>A</span></div><div data-slot="toolbar-flyout-body" class="flex flex-col items-stretch gap-3.5 pt-1 pb-0.5 px-0.5 max-h-[60vh] overflow-y-auto"><div></div></div></div></div><div data-slot="toolbar-popover" class="relative flex flex-col items-center w-full"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-1" aria-controls="toolbar-flyout-left-1" aria-expanded="false" title="B" aria-label="B"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-b"></use></svg></button><div id="toolbar-flyout-left-1" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 p-2 pb-2.5 rounded-xl border border-border bg-popover text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-0.5 pb-1.5 px-0.5 flex items-center justify-between gap-2"><span>B</span></div><div data-slot="toolbar-flyout-body" class="flex flex-col items-stretch gap-3.5 pt-1 pb-0.5 px-0.5 max-h-[60vh] overflow-y-auto"><div></div></div></div></div></div></nav>',
    );
  });
  ...
  it("namespaces flyout ids by an explicit id prop and stamps that id on the nav", async () => {
    ...
    expect(out).toBe(
      '<nav id="scene-rail" role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><div data-slot="toolbar-popover" class="relative flex flex-col items-center w-full"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-scene-rail-0" aria-controls="toolbar-flyout-scene-rail-0" aria-expanded="false" title="Layers" aria-label="Layers"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-scene-rail-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 p-2 pb-2.5 rounded-xl border border-border bg-popover text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-0.5 pb-1.5 px-0.5 flex items-center justify-between gap-2"><span>Layers</span></div><div data-slot="toolbar-flyout-body" class="flex flex-col items-stretch gap-3.5 pt-1 pb-0.5 px-0.5 max-h-[60vh] overflow-y-auto"><div></div></div></div></div></div></nav>',
    );
  });
});
...
describe("Toolbar — action dispatch", () => {
  it("emits data-on-click for a scope-dispatched action (default)", async () => {
    ...
    const out = await render(<Toolbar config={config} icon={icon} />);
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" data-on-click="select" data-tool="select"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></nav>',
    );
  });
...
describe("Toolbar — glyph typing", () => {
  ...
  it("accepts a sheet narrowed to the definition's glyphs, uncast", async () => {
    ...
    expect(out).toBe(
      '<nav role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex flex-col items-center gap-0.5 w-full"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" data-on-click="select"><svg data-slot="icon" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></nav>',
    );
  });
