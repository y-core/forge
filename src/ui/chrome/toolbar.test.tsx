...
describe("Toolbar — popover title", () => {
  it("renders toolbar-flyout-title with the popover label", async () => {
    ...
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><div data-slot="toolbar-popover" class="relative flex w-full flex-col items-center"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-0" aria-controls="toolbar-flyout-left-0" aria-expanded="false" title="Groups" aria-label="Groups"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-left-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 rounded-xl border border-border bg-popover p-2 pb-2.5 text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="px-0.5 pt-0.5 pb-1.5 text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center justify-between gap-2"><span>Groups</span></div><div data-slot="toolbar-flyout-body" class="flex max-h-[60vh] flex-col items-stretch gap-3.5 overflow-y-auto px-0.5 pt-1 pb-0.5"><div></div></div></div></div></div></div>',
    );
  });
  ...
  it("renders the title as a flex row (label + no action button) without titleAction", async () => {
    ...
    const out = await render(<Toolbar config={config} icon={icon} />);
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><div data-slot="toolbar-popover" class="relative flex w-full flex-col items-center"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-0" aria-controls="toolbar-flyout-left-0" aria-expanded="false" title="Layers" aria-label="Layers"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-left-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 rounded-xl border border-border bg-popover p-2 pb-2.5 text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="px-0.5 pt-0.5 pb-1.5 text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center justify-between gap-2"><span>Layers</span></div><div data-slot="toolbar-flyout-body" class="flex max-h-[60vh] flex-col items-stretch gap-3.5 overflow-y-auto px-0.5 pt-1 pb-0.5"><div></div></div></div></div></div></div>',
    );
  });
...
describe("Toolbar — native popover flyout", () => {
  ...
  it("renders the flyout as a native popover carrying the linking id and placement", async () => {
    ...
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><div data-slot="toolbar-popover" class="relative flex w-full flex-col items-center"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-right-0" aria-controls="toolbar-flyout-right-0" aria-expanded="false" title="Layers" aria-label="Layers"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-right-0" data-slot="toolbar-flyout" popover="auto" data-placement="right" class="min-w-52 rounded-xl border border-border bg-popover p-2 pb-2.5 text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="px-0.5 pt-0.5 pb-1.5 text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center justify-between gap-2"><span>Layers</span></div><div data-slot="toolbar-flyout-body" class="flex max-h-[60vh] flex-col items-stretch gap-3.5 overflow-y-auto px-0.5 pt-1 pb-0.5"><div></div></div></div></div></div></div>',
    );
  });
  ...
  it("mints a distinct id for each popover so triggers and flyouts stay paired", async () => {
    ...
    const out = await render(<Toolbar config={config} icon={icon} />);
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><div data-slot="toolbar-popover" class="relative flex w-full flex-col items-center"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-0" aria-controls="toolbar-flyout-left-0" aria-expanded="false" title="A" aria-label="A"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-a"></use></svg></button><div id="toolbar-flyout-left-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 rounded-xl border border-border bg-popover p-2 pb-2.5 text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="px-0.5 pt-0.5 pb-1.5 text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center justify-between gap-2"><span>A</span></div><div data-slot="toolbar-flyout-body" class="flex max-h-[60vh] flex-col items-stretch gap-3.5 overflow-y-auto px-0.5 pt-1 pb-0.5"><div></div></div></div></div><div data-slot="toolbar-popover" class="relative flex w-full flex-col items-center"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-left-1" aria-controls="toolbar-flyout-left-1" aria-expanded="false" title="B" aria-label="B"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-b"></use></svg></button><div id="toolbar-flyout-left-1" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 rounded-xl border border-border bg-popover p-2 pb-2.5 text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="px-0.5 pt-0.5 pb-1.5 text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center justify-between gap-2"><span>B</span></div><div data-slot="toolbar-flyout-body" class="flex max-h-[60vh] flex-col items-stretch gap-3.5 overflow-y-auto px-0.5 pt-1 pb-0.5"><div></div></div></div></div></div></div>',
    );
  });
  ...
  it("namespaces flyout ids by an explicit id prop and stamps that id on the nav", async () => {
    ...
    expect(out).toBe(
      '<div id="scene-rail" role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><div data-slot="toolbar-popover" class="relative flex w-full flex-col items-center"><button type="button" data-slot="toolbar-button toolbar-trigger" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" command="toggle-popover" commandfor="toolbar-flyout-scene-rail-0" aria-controls="toolbar-flyout-scene-rail-0" aria-expanded="false" title="Layers" aria-label="Layers"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-layers"></use></svg></button><div id="toolbar-flyout-scene-rail-0" data-slot="toolbar-flyout" popover="auto" data-placement="left" class="min-w-52 rounded-xl border border-border bg-popover p-2 pb-2.5 text-popover-foreground shadow-md"><div data-slot="toolbar-flyout-title" class="px-0.5 pt-0.5 pb-1.5 text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center justify-between gap-2"><span>Layers</span></div><div data-slot="toolbar-flyout-body" class="flex max-h-[60vh] flex-col items-stretch gap-3.5 overflow-y-auto px-0.5 pt-1 pb-0.5"><div></div></div></div></div></div></div>',
    );
  });
});
...
describe("Toolbar — action dispatch", () => {
  it("emits data-on-click for a scope-dispatched action (default)", async () => {
    ...
    const out = await render(<Toolbar config={config} icon={icon} />);
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" data-on-click="select" data-tool="select"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></div>',
    );
  });
  ...
  it("emits a native --command targeting commandTarget when dispatch is command", async () => {
    ...
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" command="--select" commandfor="chrome-root" data-tool="select"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></div>',
    );
  });
});
...
describe("Toolbar — glyph typing", () => {
  ...
  it("accepts a sheet narrowed to the definition's glyphs, uncast", async () => {
    ...
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="vertical" aria-orientation="vertical" class="group flex flex-col items-center"><div data-slot="toolbar-group" class="flex w-full flex-col items-center gap-0.5"><button type="button" data-slot="toolbar-button toolbar-action" class="inline-flex items-center justify-center rounded-lg font-medium whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-safe:transition-colors text-foreground hover:bg-accent size-9 p-0" data-toolbar-item="" title="Select" aria-label="Select" data-on-click="select"><svg data-slot="icon" viewBox="0 0 24 24" class="h-5 w-5" aria-hidden="true"><use href="/sprite.svg#icon-cursor"></use></svg></button></div></div>',
    );
  });
...
describe("Toolbar — attribute precedence", () => {
  it("lets a caller's explicit data-orientation beat the one computed from placement", async () => {
    ...
    expect(out).toBe(
      '<div role="toolbar" data-slot="toolbar" data-scope="toolbar" data-orientation="caller-wins" aria-orientation="vertical" class="group flex flex-col items-center"></div>',
    );
  });
});
