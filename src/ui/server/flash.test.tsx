...
describe("Flash", () => {
  ...
  it("maps info type to info variant", async () => {
    ...
    expect(out).toBe(
      '<div data-slot="toast" data-variant="info" data-scope="toast" data-state="{&quot;duration&quot;:5000}" class="relative flex w-full items-start gap-3 rounded-xl border py-4 ps-4 shadow-lg border-status-info-border bg-status-info-subtle text-status-info-subtle-foreground pe-10"><div data-slot="toast-body" class="flex-1 space-y-1"><div data-slot="toast-description" class="text-sm opacity-90">FYI</div></div><button type="button" data-slot="toast-close" aria-label="Dismiss notification" data-on-click="dismiss" class="absolute end-2 top-2 inline-flex size-8 items-center justify-center rounded opacity-50 hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none motion-safe:transition-opacity"><span aria-hidden="true" class="text-sm leading-none">×</span></button></div>',
    );
  });
  ...
  it("maps warning type to warning variant", async () => {
    ...
    expect(out).toBe(
      '<div data-slot="toast" data-variant="warning" data-scope="toast" data-state="{&quot;duration&quot;:5000}" class="relative flex w-full items-start gap-3 rounded-xl border py-4 ps-4 shadow-lg border-status-warning-border bg-status-warning-subtle text-status-warning-subtle-foreground pe-10"><div data-slot="toast-body" class="flex-1 space-y-1"><div data-slot="toast-description" class="text-sm opacity-90">Careful</div></div><button type="button" data-slot="toast-close" aria-label="Dismiss notification" data-on-click="dismiss" class="absolute end-2 top-2 inline-flex size-8 items-center justify-center rounded opacity-50 hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none motion-safe:transition-opacity"><span aria-hidden="true" class="text-sm leading-none">×</span></button></div>',
    );
  });
