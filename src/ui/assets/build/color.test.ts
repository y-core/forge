...
describe("parseColor()", () => {
  ...
  it("expands #rgb and #rgba shorthand, which Tailwind v4 emits", () => {
    expect(parseColor("#fff")).toEqual(parseColor("#ffffff"));
    expect(parseColor("#abc")).toEqual(parseColor("#aabbcc"));
    expect(parseColor("#ffff")).toEqual(parseColor("#ffffffff"));
    expect(parseColor("#abcf")).toEqual(parseColor("#aabbccff"));
  });
