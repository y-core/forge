...
export const CONTRAST_PAIRS: readonly ContrastPair[] = [
  ...
  },
  {
    ...
    role: "text on a `tone='secondary'` solid fill and every secondary surface",
    step: "--gray-12",
    foreground: gray(11),
  ...
  },
  {
    ...
    against: { light: "--success (--color-emerald-700)", dark: "--success (--color-emerald-700)" },
    criterion: "1.4.3",
  },
  {
  ...
  },
  {
    ...
    role: "text on the primary fill — `Button` at its default `tone='primary'`, the one control every forge app renders",
  ...
  {
    token: "--primary-text",
    role: "the primary tone as text — a `tone='primary'` Link, Badge outline, or ghost Button, read on a page surface",
    step: "--accent-11",
    foreground: accent(10),
    background: gray(2),
    against: { light: "--muted (--gray-3)", dark: "--muted (--gray-3)" },
    criterion: "1.4.3",
  },
  {
    token: "--primary-soft-foreground",
    role: "text on the primary soft surface — `tone='primary' appearance='soft'`",
    step: "--accent-12",
    foreground: accent(11),
    background: accent(2),
    against: { light: "--primary-soft (--accent-3)", dark: "--primary-soft (--accent-3)" },
    criterion: "1.4.3",
  },
  {
    token: "--success-text",
    role: "success text on a page surface — `tone='success'` in a Link, Status, or ghost Button",
    step: "--emerald-11",
    foreground: fixed("--success-text"),
    background: gray(2),
    against: { light: "--muted (--gray-3)", dark: "--muted (--gray-3)" },
    criterion: "1.4.3",
  },
  {
    ...
    role: "error text — `text-destructive-text` is what FieldError, Label's required marker and Turnstile's fallback resolve to",
    step: "--red-11",
    foreground: fixed("--destructive-text"),
    background: gray(2),
    against: { light: "--muted (--gray-3)", dark: "--muted (--gray-3)" },
    criterion: "1.4.3",
  },
  {
    ...
    role: "text on a filled destructive surface — what `Button tone='destructive'` resolves to, and the reason a caller no longer picks a foreground by hand",
    step: "--red-contrast",
    foreground: fixed("--destructive-foreground"),
    background: fixed("--destructive"),
    against: { light: "--destructive (--color-red-700)", dark: "--destructive (--color-red-700)" },
    criterion: "1.4.3",
  },
  {
    token: "--info-text",
    role: "informational text on a page surface — `text-info-text` in a Link or Status of that tone",
    step: "--blue-11",
    foreground: fixed("--info-text"),
    background: gray(2),
    against: { light: "--muted (--gray-3)", dark: "--muted (--gray-3)" },
    criterion: "1.4.3",
  },
  {
    ...
    role: "text on a filled informational surface — what `tone='info' appearance='solid'` resolves to",
    step: "--blue-contrast",
    foreground: fixed("--info-foreground"),
    background: fixed("--info"),
    against: { light: "--info (--color-blue-700)", dark: "--info (--color-blue-700)" },
    criterion: "1.4.3",
  },
  {
    token: "--warning-text",
    role: "caution text on a page surface — `tone='warning'` in a Link, Status, or ghost Button",
    step: "--yellow-11",
    foreground: fixed("--warning-text"),
    background: gray(2),
    against: { light: "--muted (--gray-3)", dark: "--muted (--gray-3)" },
    criterion: "1.4.3",
  },
  {
    ...
    against: { light: "--warning (--color-yellow-500)", dark: "--warning (--color-yellow-500)" },
    criterion: "1.4.3",
  },
  ...
  },
  {
    ...
    role: "the text of a failure chip — `Badge tone='destructive'`, rendered at `text-xs`",
    step: "--red-11",
  ...
  },
  {
    ...
    role: "the text of a warning chip — `Badge tone='warning'`, rendered at `text-xs`",
    step: "--yellow-11",
  ...
  },
  {
    ...
    role: "the text of a success chip — `Badge tone='success'`, rendered at `text-xs`",
    step: "--emerald-11",
  ...
  },
  {
    ...
    role: "the text of an informational chip — `Badge tone='info'`, rendered at `text-xs`",
    step: "--blue-11",
