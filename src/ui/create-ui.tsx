...
/** Icon names every bound forge component requires. The injected icon must supply all of them. */
...
/**
 * Binds the sprite-backed forge components to an app-provided icon, mirroring the `createIcon`
 ...
 */
export function createUI(icon: ForgeIcon<UIIconName>) {
